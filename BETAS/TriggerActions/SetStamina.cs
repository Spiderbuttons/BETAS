...
public static class SetStamina
{
    ...
    {
        if (!TokenizableArgUtility.TryGetInt(args, 1, out var stamina, out error) || !TokenizableArgUtility.TryGetOptionalBool(args, 2, out var overrideBool, out error, defaultValue: false))
        {
