...
public static class DelayedAction
{
    ...
    {
        if (!ArgUtilityExtensions.TryGetTokenizable(args, 1, out var actionString, out error, allowBlank: false) || !ArgUtilityExtensions.TryGetTokenizableInt(args, 2, out var delay, out error))
        {
