...
Most often, the `Target` item will contain information about the trigger event stored in its mod data and will require the use of the new item Game State Queries added by BETAS to access said information. The `Target` location of the trigger will be wherever the trigger occured or the event was witnessed, usually the current location of the local player.
